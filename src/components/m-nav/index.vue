      ...
      <div class="menuDiv">
        <t-space size="30px">
          <router-link to="/my/apps">
            <t-link :underline="route.fullPath.startsWith('/my/apps')"
              >MyApps</t-link
            >
          </router-link>
          <router-link to="/console">
            <t-link :underline="route.fullPath.startsWith('/console')"
              >Console</t-link
            >
          </router-link>
        </t-space>
        ...
        <t-dropdown>
          ...
          <t-dropdown-menu>
            <t-dropdown-item disabled :divider="true">
              <span
                >User:
                {{ userStore.info?.nickname || userStore.info?.username }}</span
              >
            </t-dropdown-item>
