<template>
  ...
  <m-container v-else class="appInfo" :routes="[{ text: 'MyApps', name: 'my_apps_list' }, { text: 'App: ' + app?.name }]">
    <!-- <div class="header">
            <div class="name">{{ app?.name }}</div>
        </div> -->
    <m-card shadow minHeight="600px">
      <t-tabs :default-value="route.name" v-model="seletedTab" @change="onChangeTab" theme="card">
